...
public class ProgramaPrincipal{
	public static void main(String [] args){
		...
		int op = Integer.parseInt(JOptionPane.showInputDialog("Digite 1- adicionar, 2- remover, 3-consultar, 4-contatos, 5-contatos Ordenados 6-sair:"));
		do{
			switch(op){
				case 1:
				...
				case 4:
					...
					break;
				case 5:
					Iterator<Contato> i = agenda.getContatosOrdenados();
					Collection<Contato> co = new ArrayList<Contato>();
					while(i.hasNext()){
						co.add(i.next());
					}
